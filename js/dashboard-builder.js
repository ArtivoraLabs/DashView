...
(function () {
  ...
  function buildStandaloneHtml(dash) {
    ...
    return '<!DOCTYPE html>\n<html lang="en">\n<head>\n<meta charset="UTF-8" />\n' +
      ...
      'header h1{font-family:"Space Grotesk",sans-serif;font-size:clamp(17px,2.4vw,22px);margin:0;word-break:break-word;}\n' +
      ...
      '.kpi-val{font-family:"Space Grotesk",sans-serif;font-size:clamp(20px,3vw,28px);font-weight:700;margin:6px 0 0;word-break:break-word;}\n' +
      ...
      '.card h2{font-family:"Space Grotesk",sans-serif;font-size:15px;margin:0 0 16px;}\n' +
